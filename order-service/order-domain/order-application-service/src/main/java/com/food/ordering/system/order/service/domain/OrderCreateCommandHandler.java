...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        Order order = orderDomainMapper.createeOrderCommandToOrder(createOrderCommand);
        OrderCreatedEvent orderCreatedEvent = orderDomainService.validateAndInitializeOrder(order, restaurant);
        Order orderResult = saveOrder(order);

        log.info("Order is created with id: {}", orderResult.getId().getValue());
        return orderDomainMapper.orderToCreateOrderResponse(orderResult);
    }
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        Restaurant restaurant = orderDomainMapper.createOrderCommandToRestaurant(createOrderCommand);
